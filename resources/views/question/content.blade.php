        ...
        <div class="share-botton input-group mb-4">
          ...
          {{-- LINE --}}
            ...
            <div class="ml-4">
              ...
              <form method="post" action="{{route ('favorite.delete', [$bookmark->id] ) }}" class="form-horizontal">
              @endforeach
              @csrf
              <button type="submit" name="favorite" class="btn btn-danger btn-sm">お気に入りから削除</button>
            </form>
            </div>
            @endif
            @endif
